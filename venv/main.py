...
firebase_admin.initialize_app(cred, {
    ...
    'storageBucket':"faceattendence-729e0.appspot.com"
    })
...
imgBackground = cv2.imread('/home/aritra/Documents/college_project/Resources/background.png')

#importing mode images into a list
folderModePath = '/home/aritra/Documents/college_project/Resources/Modes'
...
while True:
    ...
    if success:
        #combining webcam with template image
        ...
        if counter!= 0:
            ...
            if counter == 1:
                ...
                blob = bucket.get_blob(f'/home/aritra/Documents/college_project/Images/{id}.jpg')
            ...
            if modeType != 2:
                ...
                if counter <= 10:
                    ...
                    cv2.putText(imgBackground,str(studentInfo['sem']),(910,625),cv2.FONT_HERSHEY_COMPLEX,0.6,(100,100,100),1)
